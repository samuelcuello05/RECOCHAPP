...
namespace Recochapp.Backend.Migrations
{
    ...
    [Migration("20250416033624_PlanDestionationName_on_Plan_Entity_Addon")]
    partial class PlanDestionationName_on_Plan_Entity_Addon
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recochapp.Shared.Entities.Plan", b =>
                {
                    ...
                    b.Property<string>("PlanDestinationName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
